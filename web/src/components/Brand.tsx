export function Brand({ size = 34 }: { size?: number }) {
  return (
    <div className="flex items-center gap-2.5">
      <div
        className="grid place-items-center rounded-xl border border-white/10 bg-gradient-to-br from-accent/30 to-batch/30 shadow-glow"
      ...
      <div className="leading-none">
        ...
        <div className="text-[10px] uppercase tracking-[0.18em] text-slate-500">Dispatch Strategy Lab</div>
      </div>
    </div>
  );
}
